...
export class Utility {
  ...
  public static isValidNexmoConfig(option: any): boolean {
    if (!option.services.nexmo && option.apiKey && option.apiSecret) {
      console.info(
        ' -------------> Invalid configure option passed, set {services.nexmo: true}\n' +
    ...
    if (option.services.nexmo && !option.apiKey && option.apiSecret) {
      console.info(
        "Invalid configure option passed, set {apiKey: 'your nexmo apiKey'}\n" +
          'follow documentation for more details \n https://www.npmjs.com/package/node-notification-service/',
      );
      return false;
    }
    if (option.services.nexmo && option.apiKey && !option.apiSecret) {
      console.info(
        "Invalid configure option passed, set {apiSecret: 'your nexmo apiSecret '}\n" +
          'follow documentation for more details \n https://www.npmjs.com/package/node-notification-service/',
      );
      return false;
    }
  ...
  public static isValidTwilioConfig(option: any): boolean {
    if (!option.services.twilio && option.accountSid && option.authToken) {
      console.info(
        ' -------------> Invalid configure option passed, set {services.twilio: true}\n' +
          'follow documentation for more details \n https://www.npmjs.com/package/node-notification-service/',
      );
      return false;
    }
    if (option.services.twilio && !option.accountSid && option.authToken) {
      console.info(
        "Invalid configure option passed, set {accountSid: 'your twilio accountSid'}\n" +
          'follow documentation for more details \n https://www.npmjs.com/package/node-notification-service/',
      );
      return false;
    }
    if (option.services.twilio && option.accountSid && !option.authToken) {
      console.info(
        "Invalid configure option passed, set {authToken: 'your twilio authToken '}\n" +
          'follow documentation for more details \n https://www.npmjs.com/package/node-notification-service/',
      );
      return false;
    }
